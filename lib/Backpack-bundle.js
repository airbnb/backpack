(function() {
  ...
  Backpack.Clickable = (function(_super) {
    ...
    Clickable.prototype.template = _.template("<a href='<%= href %>'><%= content %></a>");
    ...
    Clickable.prototype.render = function() {
      this.$el.html(this._content);
      return this;
    };

    Clickable.prototype.content = function(content, events) {
  ...
  Backpack.Tabs = (function(_super) {
    ...
    Tabs.prototype.setActive = function() {
      var activeTab;
      activeTab = this.items[this.active];
  ...
  Backpack.TabContent = (function(_super) {
    ...
    TabContent.prototype.initialize = function() {
      ...
      return this.addClass('backpack-tab-content round-bottom');
    };
